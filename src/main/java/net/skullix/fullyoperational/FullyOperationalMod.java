package net.skullix.fullyoperational;
...
public class FullyOperationalMod {
	public static final Logger LOGGER = LogManager.getLogger(FullyOperationalMod.class);
	public static final String MODID = "fully_operational";

	public FullyOperationalMod() {
