package net.skullix.fullyoperational.block.entity;
...
public class VermetraPlushTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public VermetraPlushTileEntity(BlockPos pos, BlockState state) {
		super(FullyOperationalModBlockEntities.VERMETRA_PLUSH.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(VermetraPlushBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<VermetraPlushTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<VermetraPlushTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("vermetra_plush");
	}
